...
(function($){
	$.fn.tinyscrollbar = function(options){
		...
		var oScrollbar = { obj: options.oScrollbar ? options.oScrollbar : $('.scrollbar', this) };
        ...
        this.position = function() {
            return parseInt(oContent.obj.css(sDirection));
        };
		function setSize(){
		...
		function start(oEvent){
			...
			oWrapper.addClass('hover');
			//oTrack.addClass('hover');
			return false;
		};
		...
		function end(oEvent){
			...
			oWrapper.removeClass('hover');
			//oTrack.removeClass('hover');
			return false;
		};
